...
import MDataGridPro from './MDataGridPro';
...
it('should render table', () => {
  const { container } = render(<MDataGridPro columns={[]} rows={[]} />);
...
it('should not render table when no data', () => {
  ...
  const { container } = render(<MDataGridPro {...props} />);
