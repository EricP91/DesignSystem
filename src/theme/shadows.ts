...
export interface ShadowsColorOption {
  z1: string;
  z8: string;
  z12: string;
  z13: string;
...
export type ShadowsOptions = (string | ShadowsColorOption)[];

export interface ShadowsThemeOptions {
  light: ShadowsOptions;
  dark: ShadowsOptions;
}

const Shadows: ShadowsThemeOptions = {
  light: [
    'none',
    ...
    // Custom
    {
      ...
      z13: `drop-shadow(0px 1px 8px ${alpha(BASE_LIGHT, 0.16)})`,
  ...
  dark: [
    ...
    // Custums
    {
      ...
      z13: `drop-shadow(0 0 2px ${alpha(BASE_DARK, 0.24)}) drop-shadow(0 12px 24px ${alpha(BASE_DARK, 0.24)})`,
